...
<body>
								...
								<form id="loginForm">
									<div class="form-label-group">
										<input type="text" id="userName" class="form-control"
											placeholder="用户名" autofocus> <label for="userName">用户名</label>
									</div>

									<div class="form-label-group">
										<input type="password" id="userPassword" class="form-control"
											placeholder="密码"> <label for="userPassword">密码</label>
									</div>

									<div id="vaptchaContainer" class="form-label-group">
										<div class="vaptcha-init-main">
											<div class="vaptcha-init-loading">
												<a href="https://www.vaptcha.com" target="_blank"> <img
   ...
   vaptcha({
        //配置参数
        vid: '5d833ebdfc650edf90ea0aa5', // 验证单元id
        type: 'click', // 展现类型 点击式
